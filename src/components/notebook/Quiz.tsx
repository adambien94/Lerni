...
export function Quiz() {
  ...
  return (
    <section className="flex min-h-0 flex-col">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "border-white/10 bg-zinc-900/60 text-foreground hover:border-white/20 hover:bg-zinc-900/80",
                  )}
                >
      ...
      {hintOpen ? (
        <p className="rounded-xl mt-4 border border-white/10 bg-zinc-950/60 px-4 py-3 text-sm text-muted-foreground">
          {current.hint}
        </p>
      ) : null}
    </section>
